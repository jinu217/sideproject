...
// 4) 프로필 이미지 경로 계산
// ===========================
$rawProfileImage = isset($user['profile_image_url']) ? $user['profile_image_url'] : '';

if (!empty($rawProfileImage)) {
    $profileImage = $rawProfileImage; 
} else {
    $profileImage = '../img/profile_img_setting.png';
}
...
// 원본 이름 + 닉네임
$raw_name = isset($user['name']) ? $user['name'] : '이름 없음';
$nickname = isset($user['nickname']) ? $user['nickname'] : null;

// 화면에 보여줄 이름: 닉네임 > 이름
$user_name = !empty($nickname) ? $nickname : $raw_name;
...
<div class="profile-page">
    ...
    <div id="tab-profile" class="profile-tab-panel">
        <?php
        $profileTab = __DIR__ . '/09_01_view_tab_profile.php';
    ...
    <div id="tab-project" class="profile-tab-panel" style="display:none;">
        <?php
        $projectTab = __DIR__ . '/09_02_view_tab_project.php';
    ...
    <div id="tab-portfolio" class="profile-tab-panel" style="display:none;">
        <?php
        $portfolioTab = __DIR__ . '/09_03_view_tab_portfolio.php';
    ...
    <div id="tab-review" class="profile-tab-panel" style="display:none;">
        <?php
        $reviewTab = __DIR__ . '/09_04_view_tab_review.php';
